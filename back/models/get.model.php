...
class GetModel{
    ...
    static public function getSquad($teamID, $orderBy, $orderMode, $startAt, $endAt){
       ...
       /**=====================sentencias sql ============================ */  
        $select="id_equipo,nombre_equipo,primerNombre_usuario,primerApellido_usuario,id_usuario,ci_usuario,numeroCamiseta_pertenece,altura_fichaJugador,peso_fichaJugador,lateralidad_fichaJugador";
