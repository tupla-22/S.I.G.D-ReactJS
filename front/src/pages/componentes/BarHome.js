...
const pages = [<NavLink classAdd={"responsive"}  to="">{text.inicio}</NavLink>,<NavLink classAdd={"responsive"} to="help">{text.ayuda}</NavLink>,<NavLink classAdd={"responsive"} to="login">{text.entrar}</NavLink>];
