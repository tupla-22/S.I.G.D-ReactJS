			...
			<Collapse in={checked}>
				{
					<Article>
						...
						<PW>
							Esta aplicación fue creada para poder llevar a cabo la gestión de los deportes
							realizados en la institución UTU. <br />y así realizar estadísticas de los jugadores y
							equipos que pertenezcan a esta web
						</PW>
					</Article>
				}
			</Collapse>
			<Collapse orientation="horizontal" in={checked}>
				{
					<Article>
						...
						<PW>
							En dicho caso deberá comunicarse con su director tércnico e informarle de esa situación
